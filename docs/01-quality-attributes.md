...
Атрибуты выбраны под драйверы D1–D4 (см. корневой README).

| Атрибут | Тип | ISO/IEC 25010 | Драйвер |
|---------|-----|---------------|---------|
| Производительность | runtime | Performance Efficiency → Time Behaviour | D2 |
